...
class ProductItemShould {
    ...
    @Before
    fun setUp() {
        mItem = Product(id = 753342,"Galaxy F2 fold","Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ",650, "Samsung","Phone","guvgvucvgc")
